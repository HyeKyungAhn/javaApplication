...
public class PachinkoViewer {
    ...
    public static void print(PachinkoPrintStatus status){
        switch (status){
            case PRINT_INFORMATION -> System.out.println("""
                    <안내>
                    ...
                    - 충전하여 지갑에 보유할 수 있는 총 액수는 21억입니다
                    """);
            case PRINT_WRONG_INPUT -> System.out.println("""
                    잘못된 입력입니다. 다시 입력해주세요.
                    ...
                    - 충전하여 지갑에 보유할 수 있는 총 액수는 21억입니다
                    """);
            case NO_PRODUCT_AVAILABLE -> System.out.println("현재 뽑기 가능한 상품이 부족합니다. 뽑기를 종료합니다.");
        }
    }
}
